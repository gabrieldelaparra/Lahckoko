...
namespace Lahckoko.Blazor
{
    public class LocationService
    {
        ...
        public async Task<Location> GetLocationAsync()
        {
            ...
            var result = await jSRuntime.InvokeAsync<Location>("Lahckoko.Blazor.GetLocation", requestId);
        ...
        public async Task WatchLocation(Action<Location> watchCallback)
        {
            ...
            await jSRuntime.InvokeAsync<Location>("Lahckoko.Blazor.WatchLocation", requestId);
        }
